...
FOX_ADMIN_FORM_FIELDS = {
    "username": {"label": "Username:", "value_key": "username"},
...
CLA_MEANS_TEST_PERSONAL_DETAILS_FORM = {
    ...
    "postcode": {
        "form_element_id": "address-post_code",
        "form_element_value": "SW1H 9AJ",
    },
    "street": {
        "form_element_id": "address-street_address",
        "form_element_value": "102 Petty France",
    },
    "email": {
...
CLA_SPECIALIST_CASE_TO_EDIT = "ED-00001-0001"
...
CLA_SPECIALIST_REJECTION_OUTCOME_CODES = {"MIS-OOS": "Misdiagnosed, out of scope"}
...
CLA_OPERATOR_CASE_TO_EDIT = "ED-0001-0002"
...
CLA_CASE_PERSONAL_DETAILS_BACKEND_CHECK = {
    "Full name": {
        "form_element_type": "h2",
        "form_element_title": "Full name",
        "backend_id": "full_name",
    },
    "Telephone": {
        "form_element_type": "p",
        "form_element_title": "Phone number",
        "backend_id": "mobile_phone",
    },
}
