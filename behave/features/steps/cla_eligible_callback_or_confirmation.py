...
@step(u'I enter my personal details')
...
@step(u'I should be shown the CLA number')
def step_impl(context):
...
@step(u'I should see my reference number after the text "Your reference number is"')
def step_impl(context):
...
@step(u'A matching case should be created on the CHS')
def step_impl(context):
...
@step(u'I enter my phone number for the callback')
def step_impl(context):
...
@step(u'I select "Call on another day"')
def step_impl(context):
...
@step(u'I select an available day and time')
def step_impl(context):
...
@step(u'I should NOT see the text "You can now call CLA on 0345 345 4 345"')
def step_impl(context):
...
@step(u'The callback should have been created on the CHS')
def step_impl(context):
