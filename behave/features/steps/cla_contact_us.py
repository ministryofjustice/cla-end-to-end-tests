...
def step_impl(context):
    ...
    full_name_input = callback_form.find_element_by_xpath("//input[@id='thirdparty-full_name'][@name='thirdparty-full_name']")
    full_name_input.send_keys(value)
    assert full_name_input.get_attribute('value') == value
...
def step_impl(context):
    value = CLA_NUMBER
    callback_form = context.helperfunc.find_by_xpath("//form")
    full_name_input = callback_form.find_element_by_xpath("//input[@id='thirdparty-contact_number']")
    full_name_input.send_keys(value)
    assert full_name_input.get_attribute('value') == value
